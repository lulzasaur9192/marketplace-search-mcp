...
export function registerHomeServices(server) {
    server.tool("home_service_cost", "Get cost estimates for home services (plumbing, electrical, cleaning, etc.). Returns min/max/average/median pricing and top-rated professionals in the area. Powered by Thumbtack data.", {
